...
const perks = [
  ...
  { icon: CheckCircle,  title: "Expert Advisory",        desc: "You'll speak directly with a senior MetaLedgerLabs specialist — not a sales representative." },
    ...
    <div style={{ background: "var(--bg)", color: "var(--tx)" }}>
      ...
      >
        ...
        <div style={{ maxWidth: 720, margin: "0 auto", position: "relative", zIndex: 1 }}>
          <motion.div initial={{ opacity: 0, y: 22 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            <div className="badge" style={{ marginBottom: "1.75rem", color: "var(--green)" }}>
              <span style={{ width: 6, height: 6, borderRadius: "50%", background: "var(--green)", flexShrink: 0 }} />
              Complimentary &nbsp;·&nbsp; 30 Minutes &nbsp;·&nbsp; No Obligation
            </div>
            <h1 className="t-h1" style={{ marginBottom: "1.25rem" }}>
              Schedule a{" "}
              <em style={{ fontStyle: "italic", color: "var(--green)" }}>Discovery Call</em>
            </h1>
            <p className="t-body-lg" style={{ maxWidth: 560, margin: "0 auto" }}>
              Book a complimentary 30-minute session with a MetaLedgerLabs senior specialist. We'll explore your objectives, evaluate fit, and outline what's genuinely achievable for your organisation.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          >
            {perks.map((p, i) => (
              ...
              >
                ...
                >
                  <p.icon size={20} style={{ color: "var(--green)" }} />
                </div>
      ...
      >
        ...
        >
          ...
          <a href="/contact" className="btn btn-jade">
            Contact MetaLedgerLabs <ArrowUpRight size={14} />
          </a>
        </motion.div>
      </section>
