...
const STATUS_COLORS = {
  ...
  approved: { bg:"var(--green-bg)",   border:"var(--green-bd)",   color:"var(--green)"  },
...
export default function Dashboard() {
  ...
  const statCards = [
    ...
    { label:"Approved",      value:stats.approved, icon:CheckCircle2, c:"var(--green)"  },
      ...
      <div style={{ maxWidth:1200, margin:"0 auto" }}>
        ...
        {loading ? (
          <div style={{ display:"flex", justifyContent:"center", alignItems:"center", height:200 }}>
            <div style={{ width:36, height:36, borderRadius:"50%", border:"3px solid var(--border)", borderTopColor:"var(--green)", animation:"spin .7s linear infinite" }}/>
                  ...
                  {filtered.map(c => {
                    ...
                    return (
                      <tr key={c.id} style={{ transition:"background .15s" }}
                        ...
                        <td style={cell}><a href={`mailto:${c.email}`} style={{color:"var(--green)",textDecoration:"none"}}>{c.email||"—"}</a></td>
